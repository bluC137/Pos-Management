        ...
        <div class="modal-body">
            <form wire:submit.prevent="store" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-1">
                        <button class="btn-success btn-sm" style="margin-top: 35px !important" wire:ignore wire:click.prevent="AddMore">
                        <i class="fa fa-plus"></i>
                        </button>

                    @if ($loop->index > 0)
                        <button class="btn-danger btn-sm" wire:ignore wire:click.prevent="Remove({{ $loop->index }})">
